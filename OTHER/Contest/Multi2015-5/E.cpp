...
// Author        : WhyWhy
// Created Time  : 2016年05月06日 星期五 19时18分12秒
// File Name     : E.cpp
...
int main() {
	...
	int a,b;
	while(~scanf("%d %d",&a,&b)) {
		if(num[a]>num[b]) puts("FIRST BIGGER");
