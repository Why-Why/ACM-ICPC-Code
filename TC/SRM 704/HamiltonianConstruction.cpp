...
// CUT begin
ifstream data("HamiltonianConstruction.sample");
...
bool do_test(int k, vector<string> __expected) {
    ...
    HamiltonianConstruction *instance = new HamiltonianConstruction();
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "HamiltonianConstruction (800 Points)" << endl << endl;
    }
